...
gh release create v1.0.53 --title "EduAssess v1.0.53 - تدقيق إنشاء ونشر الاختبار" --generate-notes
gh release upload v1.0.53 adaptive-mastery-v1.0.53.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.53
