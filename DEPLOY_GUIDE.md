...
gh release create v1.0.40 --title "EduAssess v1.0.40 - بيانات ديمو شاملة" --generate-notes
gh release upload v1.0.40 adaptive-mastery-v1.0.40.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.40
