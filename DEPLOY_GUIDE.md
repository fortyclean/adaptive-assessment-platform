...
gh release create v1.0.59 --title "EduAssess v1.0.59 - تدقيق إدارة المستخدمين" --generate-notes
gh release upload v1.0.59 adaptive-mastery-v1.0.59.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.59
