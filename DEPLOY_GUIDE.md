...
gh release create v1.0.48 --title "EduAssess v1.0.48 - حماية fallback الإنتاجي" --generate-notes
gh release upload v1.0.48 adaptive-mastery-v1.0.48.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.48
