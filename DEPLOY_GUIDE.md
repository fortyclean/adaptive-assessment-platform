...
gh release create v1.0.44 --title "EduAssess v1.0.44 - تنظيف لوحة المعلم للإنتاج" --generate-notes
gh release upload v1.0.44 adaptive-mastery-v1.0.44.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.44
