...
gh release create v1.0.55 --title "EduAssess v1.0.55 - تحسين تعيين مهام المعلم" --generate-notes
gh release upload v1.0.55 adaptive-mastery-v1.0.55.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.55
