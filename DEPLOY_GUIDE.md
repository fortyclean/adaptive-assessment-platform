...
gh release create v1.0.49 --title "EduAssess v1.0.49 - مصدر typed للتعلم المصغر" --generate-notes
gh release upload v1.0.49 adaptive-mastery-v1.0.49.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.49
