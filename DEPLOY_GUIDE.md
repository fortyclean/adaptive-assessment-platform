...
gh release create v1.0.70 --title "EduAssess v1.0.70 - توسيع ترجمة شاشات الإعدادات" --generate-notes
gh release upload v1.0.70 adaptive-mastery-v1.0.70.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.70
