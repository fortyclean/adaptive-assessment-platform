...
gh release create v1.0.64 --title "EduAssess v1.0.64 - توحيد بطاقات الثيم وإصلاح ملف الطالب" --generate-notes
gh release upload v1.0.64 adaptive-mastery-v1.0.64.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.64
