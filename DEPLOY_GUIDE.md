...
gh release create v1.0.76 --title "EduAssess v1.0.76 - Teacher dashboard localization" --generate-notes
gh release upload v1.0.76 adaptive-mastery-v1.0.76.apk --clobber
```
...
```bash
flutter build apk --release --dart-define=SENTRY_DSN=https://public@sentry.example/project --dart-define=APP_RELEASE=adaptive-mastery@1.0.76+76 --dart-define=APP_ENV=production
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.76
