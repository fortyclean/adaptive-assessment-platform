...
gh release create v1.0.46 --title "EduAssess v1.0.46 - تحسين تحديات الطالب" --generate-notes
gh release upload v1.0.46 adaptive-mastery-v1.0.46.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.46
