...
gh release create v1.0.63 --title "EduAssess v1.0.63 - تدقيق بصري واستجابة الشاشات" --generate-notes
gh release upload v1.0.63 adaptive-mastery-v1.0.63.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.63
