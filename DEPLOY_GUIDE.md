...
gh release create v1.0.42 --title "EduAssess v1.0.42 - بدء جاهزية الإنتاج" --generate-notes
gh release upload v1.0.42 adaptive-mastery-v1.0.42.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.42
