...
gh release create v1.0.84 --title "EduAssess v1.0.84 - Classroom list localization" --generate-notes
gh release upload v1.0.84 adaptive-mastery-v1.0.84.apk --clobber
```
...
```bash
flutter build apk --release --dart-define=SENTRY_DSN=https://public@sentry.example/project --dart-define=APP_RELEASE=adaptive-mastery@1.0.84+84 --dart-define=APP_ENV=production
```
...
آخر تحديث: يونيو 2026 | EduAssess v1.0.84
