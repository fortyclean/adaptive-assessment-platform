...
gh release create v1.0.47 --title "EduAssess v1.0.47 - تفعيل إدارة مهام المعلم" --generate-notes
gh release upload v1.0.47 adaptive-mastery-v1.0.47.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.47
