...
gh release create v1.0.67 --title "EduAssess v1.0.67 - تنظيف ألوان التقارير والتحديات والفصول" --generate-notes
gh release upload v1.0.67 adaptive-mastery-v1.0.67.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.67
