...
gh release create v1.0.45 --title "EduAssess v1.0.45 - تحسين متجر النقاط" --generate-notes
gh release upload v1.0.45 adaptive-mastery-v1.0.45.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.45
