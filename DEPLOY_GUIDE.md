...
gh release create v1.0.43 --title "EduAssess v1.0.43 - تنظيف لوحة الطالب للإنتاج" --generate-notes
gh release upload v1.0.43 adaptive-mastery-v1.0.43.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.43
