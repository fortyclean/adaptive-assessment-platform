...
gh release create v1.0.61 --title "EduAssess v1.0.61 - سجل تدقيق المشرف" --generate-notes
gh release upload v1.0.61 adaptive-mastery-v1.0.61.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.61
