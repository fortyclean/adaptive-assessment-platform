...
gh release create v1.0.41 --title "EduAssess v1.0.41 - تحسين رحلة تعلم الطالب" --generate-notes
gh release upload v1.0.41 adaptive-mastery-v1.0.41.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.41
