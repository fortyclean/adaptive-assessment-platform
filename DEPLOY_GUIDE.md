...
gh release create v1.0.62 --title "EduAssess v1.0.62 - تقارير المدرسة ورحلة المشرف" --generate-notes
gh release upload v1.0.62 adaptive-mastery-v1.0.62.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.62
