...
gh release create v1.0.52 --title "EduAssess v1.0.52 - إكمال حزمة تحسينات الطالب" --generate-notes
gh release upload v1.0.52 adaptive-mastery-v1.0.52.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.52
