...
gh release create v1.0.60 --title "EduAssess v1.0.60 - تدقيق ربط الفصول" --generate-notes
gh release upload v1.0.60 adaptive-mastery-v1.0.60.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.60
