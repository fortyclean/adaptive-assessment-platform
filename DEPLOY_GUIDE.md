...
gh release create v1.0.69 --title "EduAssess v1.0.69 - بدء دعم الترجمة وتبديل اللغة" --generate-notes
gh release upload v1.0.69 adaptive-mastery-v1.0.69.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.69
