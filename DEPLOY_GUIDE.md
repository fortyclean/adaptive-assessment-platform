...
gh release create v1.0.56 --title "EduAssess v1.0.56 - تنظيف الجدول الدراسي" --generate-notes
gh release upload v1.0.56 adaptive-mastery-v1.0.56.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.56
