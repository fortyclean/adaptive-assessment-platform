...
gh release create v1.0.73 --title "EduAssess v1.0.73 - اختبارات رحلات الأدوار الأساسية" --generate-notes
gh release upload v1.0.73 adaptive-mastery-v1.0.73.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.73
