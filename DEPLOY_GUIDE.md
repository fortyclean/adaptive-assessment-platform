...
gh release create v1.0.54 --title "EduAssess v1.0.54 - إشعارات نشر الاختبار للفصول" --generate-notes
gh release upload v1.0.54 adaptive-mastery-v1.0.54.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.54
