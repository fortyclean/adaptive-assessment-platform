...
gh release create v1.0.68 --title "EduAssess v1.0.68 - إكمال تنظيف الثيم للشهادات ولوحة المشرف" --generate-notes
gh release upload v1.0.68 adaptive-mastery-v1.0.68.apk --clobber
```
...
آخر تحديث: مايو 2026 | EduAssess v1.0.68
