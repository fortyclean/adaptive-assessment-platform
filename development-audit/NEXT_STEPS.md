...
4. Plan a focused `uuid` major-upgrade compatibility check.
5. Replace, sandbox, or gate `xlsx` import handling before Beta because npm audit has no fix for the current package.
