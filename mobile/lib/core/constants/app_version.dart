...
class AppVersion {
  ...
  static const String current = '1.0.111';
  ...
  static const List<VersionEntry> changelog = [
    VersionEntry(
      ...
      buildNumber: 111,
      date: 'يوليو 2026',
      title: 'تغطية API لاستيراد XLSX',
      changes: [
        'إضافة اختبار لمسار رفع ملف XLSX في API الخاص ببنك الأسئلة.',
        'التحقق من رفض ملفات .xls القديمة قبل الوصول إلى خدمة الاستيراد.',
        'تثبيت عقد رفع ملفات الأسئلة بعد حصر الصيغة في .xlsx.',
      ],
    ...
    VersionEntry(
      ...
      buildNumber: 102,
      date: 'يونيو 2026',
      title: 'تثبيت البناء والتحقق قبل الإصدار',
      changes: [
        'توحيد Flutter وNode في إعدادات البناء والتدقيق الآلي.',
        'جعل بناء APK يدويًا أو عبر الوسم بدل تشغيله عند كل دفع.',
        'استخراج اسم حزمة البناء من رقم الإصدار تلقائيًا.',
        'إضافة lint ومراجعة الاعتماديات إلى بوابات الجودة.',
      ],
      type: VersionType.fix,
    ),
    VersionEntry(
    ...
    VersionEntry(
      ...
      buildNumber: 97,
      date: 'يونيو 2026',
      title: 'ترجمة إعدادات المؤسسة',
      changes: [
        'نقل شاشة إعدادات المؤسسة الرئيسية إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة رسائل المزامنة والحفظ والتحقق من بيانات التواصل.',
        'ترجمة شرائح الأعوام الدراسية ومقاييس التقييم وسجل التدقيق والتنبيهات.',
        'ترجمة إعدادات اللغة والتكاملات وحوار الأرشفة مع اختبار حماية جديد.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
    ...
    VersionEntry(
      ...
      buildNumber: 94,
      date: 'يونيو 2026',
      title: 'ترجمة لوحة المشرف المتقدمة',
      changes: [
        'نقل لوحة المشرف المتقدمة إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة العنوان والترحيب وبطاقات الإحصائيات ومؤشر الحالة.',
        'ترجمة مخطط أداء المواد وقائمة المعلمين المتميزين وتنبيهات الإدارة.',
        'ترجمة أزرار الوصول السريع وإضافة اختبار حماية لمفاتيح اللوحة المتقدمة.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 93,
      date: 'يونيو 2026',
      title: 'ترجمة لوحة المشرف واستعادة كلمة المرور',
      changes: [
        'نقل شاشة نسيان كلمة المرور إلى مفاتيح ترجمة عربية وإنجليزية.',
        'نقل لوحة المشرف الرئيسية إلى مفاتيح ترجمة تشمل الترحيب والإحصائيات والتنبيهات والروابط السريعة.',
        'ترجمة بطاقة الأداء الشهرية ورسائل تغير الأداء والعدادات الديناميكية.',
        'إضافة اختبار حماية للحزمة الجديدة مع استمرار التحقق من تطابق إصدار عن التطبيق مع الإصدار الحالي.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 92,
      date: 'يونيو 2026',
      title: 'ترجمة شاشة عن التطبيق',
      changes: [
        'نقل شاشة عن التطبيق وسجل الإصدارات إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة عنوان الشاشة ووصف التطبيق وبطاقة الإصدار الحالي.',
        'ترجمة تسميات أنواع الإصدارات مثل إصدار وميزة وإصلاح وطارئ.',
        'إضافة اختبار حماية لمفاتيح شاشة عن التطبيق مع الحفاظ على تطابق سجل الإصدار الحالي.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 91,
      date: 'يونيو 2026',
      title: 'ترجمة شاشة إنشاء الحساب',
      changes: [
        'نقل شاشة إنشاء الحساب إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة رسائل التحقق للاسم واسم المستخدم والبريد وكلمة المرور.',
        'ترجمة رسائل إرسال طلب الانضمام وأخطاء التكرار وحوار الشروط والأحكام.',
        'إضافة اختبار حماية لمفاتيح شاشة التسجيل مع التأكد من خلو الشاشة من النصوص العربية الثابتة.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
    ...
    VersionEntry(
      ...
      buildNumber: 89,
      date: 'يونيو 2026',
      title: 'إصلاح عرض الإصدار داخل عن التطبيق',
      changes: [
        'إصلاح توقف بطاقة عن التطبيق وسجل الإصدارات عند إصدار قديم رغم تثبيت APK أحدث.',
        'إضافة سجلات الإصدارات المفقودة من 1.0.85 إلى 1.0.88 داخل مصدر الإصدار الموحد.',
        'تحديث اختبار AppVersion ليتحقق من تطابق أول سجل في changelog مع الإصدار الحالي دائمًا.',
        'بناء APK جديد لضمان ظهور الإصدار الحالي داخل التطبيق بعد التثبيت على الهاتف.',
      ],
      type: VersionType.fix,
    ),
    VersionEntry(
      ...
      buildNumber: 88,
      date: 'يونيو 2026',
      title: 'ترجمة شاشة التعريف الأولى',
      changes: [
        'نقل شاشة التعريف الأولى Onboarding إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة شرائح التقييم التكيفي والتحليلات المتقدمة والنقاط والإنجازات.',
        'ترجمة أزرار التخطي والتالي وابدأ الآن مع الحفاظ على الرسوم والحركة الحالية.',
        'إضافة اختبار حماية لمفاتيح شاشة التعريف الأولى مع تحليل Flutter نظيف.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 87,
      date: 'يونيو 2026',
      title: 'ترجمة شاشة تسجيل الدخول',
      changes: [
        'نقل شاشة تسجيل الدخول إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة رسائل الانتظار وتشغيل الخادم وأخطاء الاتصال والاعتماد وبيانات الدخول.',
        'ترجمة تسجيل الدخول عبر Google ورسائل طلب الانضمام ووضع العرض التجريبي.',
        'نقل أسماء حسابات الديمو ورسائل خدمة Google Auth إلى مسار قابل للترجمة وإضافة اختبار حماية.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 86,
      date: 'يونيو 2026',
      title: 'ترجمة مكوّنات رسائل النظام',
      changes: [
        'نقل شاشة مكوّنات رسائل النظام إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة رسائل النجاح والخطأ ونافذة حذف الاختبار وأزرار التأكيد والإلغاء.',
        'ترجمة حالة المزامنة والتنبيهات المعلقة وحالة الأمان وتسمية الوصول المسجل.',
        'إعادة استخدام مفاتيح التنقل السفلي المشتركة وإضافة اختبار حماية لمفاتيح شاشة الرسائل.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 85,
      date: 'يونيو 2026',
      title: 'ترجمة شاشة الدعم الفني',
      changes: [
        'نقل شاشة الدعم الفني والمساعدة إلى مفاتيح ترجمة عربية وإنجليزية.',
        'ترجمة البحث والأقسام العامة والتقنية والفواتير وحوارات الأسئلة الشائعة.',
        'ترجمة التواصل مع الدعم والمحادثة الفورية وتذكرة الدعم ورسائل الإرسال.',
        'ترجمة الشروحات التعليمية والتنقل السفلي وإضافة اختبار حماية لمفاتيح شاشة الدعم.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
    ...
    VersionEntry(
      ...
      buildNumber: 76,
      date: 'مايو 2026',
      title: 'ترجمة لوحة المعلم',
      changes: [
        'نقل عناوين لوحة المعلم ورسائل إعادة المحاولة والإحصاءات والروابط السريعة وحالات الاختبارات إلى مفاتيح ترجمة.',
        'تحسين اتجاه نصوص لوحة المعلم ليعتمد على اللغة النشطة بدل اتجاه ثابت.',
        'إضافة تغطية عربية وإنجليزية لنصوص لوحة المعلم.',
        'إضافة اختبار ترجمة لنصوص لوحة المعلم.',
        'تحديث تقدم المهمة 38.2b ضمن شاشات المعلم.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 75,
      date: 'مايو 2026',
      title: 'ترجمة البطاقات التعليمية وخطة اختبار الجهاز',
      changes: [
        'نقل نصوص شاشة البطاقات التعليمية وحالات الفراغ والأخطاء ودلالات الوصول إلى مفاتيح ترجمة.',
        'إضافة تغطية عربية وإنجليزية لإجراءات تدريب البطاقات وملخص النتائج.',
        'إضافة اختبار ترجمة لنصوص تدريب البطاقات.',
        'توثيق خطة اختبار OneSignal وتحديث APK على جهاز حقيقي.',
        'تحديث تقدم المهمة 38.2b مع إبقاء اختبارات الجهاز الحقيقي مفتوحة حتى تنفيذها فعليًا.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
      ...
      buildNumber: 74,
      date: 'مايو 2026',
      title: 'تتبع أعطال الإنتاج',
      changes: [
        'إضافة تتبع أعطال اختياري عبر SENTRY_DSN بدون تضمين أسرار داخل الكود.',
        'تفعيل معالجات أخطاء Flutter وZone العامة قبل تشغيل خدمات بدء التطبيق.',
        'تعطيل البيانات الشخصية ولقطات الشاشة وتتبع الأداء افتراضيًا.',
        'إضافة اختبار لخدمة تتبع الأعطال لضمان أمان التشغيل المحلي وCI بدون DSN.',
        'تعليم المهمة 39.3 كمكتملة في خطة التنفيذ.',
      ],
      type: VersionType.feature,
    ),
    VersionEntry(
