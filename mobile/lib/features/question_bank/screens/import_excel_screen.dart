      ...
      'errors': [
        {
          'row': 5,
          'type': 'missing_field',
          'description': 'حقل المادة مفقود في الصف 5'
        },
          ...
          actions: [
            TextButton.icon(
              ...
              label: const Text('تحميل القالب',
                  style: TextStyle(
                      color: AppColors.primary, fontFamily: 'Almarai')),
            ...
            child: _isUploading
                ...
                : Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      const Text('اضغط لاختيار ملف Excel',
                          style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w600,
                              color: AppColors.primary,
                              fontFamily: 'Almarai')),
                      const SizedBox(height: 4),
                      const Text('.xlsx أو .xls أو .csv (حتى 10MB)',
                          style: TextStyle(
                              fontSize: 12,
                              color: AppColors.onSurfaceVariant,
                              fontFamily: 'Almarai')),
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
                child: Text(_error!,
                    style: const TextStyle(
                        color: AppColors.error, fontFamily: 'Almarai'),
                    textDirection: TextDirection.rtl)),
            IconButton(
          ...
          if (imported > 0) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('تم — تمت إضافة $imported سؤال',
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text(label,
                  style: TextStyle(
                      color: color, fontSize: 12, fontFamily: 'Almarai')),
            ],
          ),
        ),
      );
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.end,
              children: [
                Text(h['fileName'] as String? ?? 'ملف Excel',
                    style: const TextStyle(
                        fontWeight: FontWeight.w600,
                        fontFamily: 'Almarai',
                        fontSize: 13)),
                Text(
                    '${h['imported']} مستورد • ${h['skipped']} متخطى • ${h['failed']} فاشل',
                    style: const TextStyle(
                        fontSize: 12,
                        color: AppColors.onSurfaceVariant,
                        fontFamily: 'Almarai')),
