...
class TeacherRepository {
  ...
  Future<Map<String, dynamic>> createAssessment(
    ...
    final response = await _apiService.dio.post<Map<String, dynamic>>('/assessments', data: data);
  ...
  Future<void> publishAssessment(String id) async {
    await _apiService.dio.post<Map<String, dynamic>>('/assessments/$id/publish');
  }

  /// GET /api/v1/questions
  Future<Map<String, dynamic>> getQuestions(
      {Map<String, dynamic>? filters, int page = 1}) async {
    final response = await _apiService.dio.get<Map<String, dynamic>>('/questions',
        queryParameters: {
          ...?filters,
          'page': page,
          'limit': 20,
  ...
  Future<Map<String, dynamic>> createQuestion(
      Map<String, dynamic> data) async {
    final response = await _apiService.dio.post<Map<String, dynamic>>('/questions', data: data);
  ...
  Future<Map<String, dynamic>> getQualityCheck(
    ...
    final response = await _apiService.dio.get<Map<String, dynamic>>('/questions/quality-check',
        queryParameters: {
          'subject': subject,
  ...
  Future<Map<String, dynamic>> getAssessmentReport(String id) async {
    final response =
        await _apiService.dio.get<Map<String, dynamic>>('/reports/assessment/$id');
    return response.data ?? {};
  }
  ...
  Future<Map<String, dynamic>> getStudentReport(String studentId,
    ...
    final response = await _apiService.dio.get<Map<String, dynamic>>('/reports/student/$studentId',
        queryParameters:
  ...
  Future<List<Map<String, dynamic>>> getClassrooms() async {
    final response = await _apiService.dio.get<Map<String, dynamic>>('/classrooms');
    return List<Map<String, dynamic>>.from(
  ...
  Future<Map<String, dynamic>> createClassroom(Map<String, dynamic> data) async {
    final response = await _apiService.dio.post<Map<String, dynamic>>('/classrooms', data: data);
  ...
  Future<Map<String, dynamic>> getClassroomCertificates(String classroomId) async {
    final response = await _apiService.dio.get<Map<String, dynamic>>('/reports/classroom/$classroomId/certificates');
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> getAttemptForGrading(String attemptId) async {
    final response = await _apiService.dio.get<Map<String, dynamic>>('/attempts/$attemptId');
    return response.data ?? {};
  }
  ...
  Future<void> submitEssayGrades(
    ...
    await _apiService.dio.post<Map<String, dynamic>>('/attempts/$attemptId/grade', data: {
