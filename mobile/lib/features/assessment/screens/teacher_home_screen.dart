...
class _TeacherHomeScreenState extends ConsumerState<TeacherHomeScreen> {
  ...
  Widget _buildAppBar(BuildContext context, String teacherName) {
    return Container(
  ...
  Widget _buildPerformanceChart() {
    final data = [
      _ChartBar(day: 'أحد', heightFraction: 0.40),
      _ChartBar(day: 'إثنين', heightFraction: 0.60),
      _ChartBar(day: 'ثلاثاء', heightFraction: 0.85),
      _ChartBar(day: 'أربعاء', heightFraction: 0.70),
      _ChartBar(day: 'خميس', heightFraction: 0.95),
    ];
