...
/// Exam With Bookmark Screen — Design _42
///
/// Variant of the exam screen that adds:
/// - A "تحديد للمراجعة" (bookmark/flag) button in the question card header
...
class ExamWithBookmarkScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ExamWithBookmarkScreen> createState() =>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Question card with bookmark + image
          _buildQuestionCard(),
          const SizedBox(height: 16),
  ...
  Widget _buildQuestionCard() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Header row: number badge + bookmark button + question text
          Row(
            ...
            children: [
              ...
              // Question text (RTL: right, expands)
              Expanded(
                child: Text(
                  questionText,
                  style: const TextStyle(
