...
class _TaskManagementScreenState extends State<TaskManagementScreen>
  ...
  final List<String> _filters = ['الكل', 'رياضيات - الصف العاشر', 'فيزياء - الصف الحادي عشر'];
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: selected ? const Color(0xFF1E40AF) : const Color(0xFFC4C5D5),
                  ),
                ),
                child: Row(
                  children: [
                    if (i == 0) ...[
                      Icon(Icons.filter_list, size: 16, color: selected ? Colors.white : AppColors.onSurfaceVariant),
  ...
  Widget _buildAssignmentCard(_AssignmentCard card) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.groups_outlined, size: 16, color: AppColors.onSurfaceVariant),
              const SizedBox(width: 4),
              Text(card.className, style: const TextStyle(color: AppColors.onSurfaceVariant, fontSize: 12)),
              const SizedBox(width: 16),
              Icon(Icons.event_outlined, size: 16, color: card.dueDateColor),
              const SizedBox(width: 4),
              Text(card.dueDate, style: TextStyle(color: card.dueDateColor, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            ...
            children: [
              const Text('نسبة الإنجاز', style: TextStyle(color: AppColors.onSurfaceVariant, fontSize: 12)),
              Text(
