...
class _StudentDashboardScreenState
  ...
  Future<void> _loadData() async {
    try {
      ...
      final upcoming =
          assessments.where((a) => a['status'] == 'active').take(3).toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  if (_isLoading)
                    ...
                    ..._upcomingAssessments.map(_buildUpcomingCard),
      ...
      bottomNavigationBar: const AppBottomNav(currentIndex: 0, role: 'student'),
    );
  }
  ...
  Widget _buildContinueLearningSection() => Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          const Padding(
  ...
  Widget _buildContinueLearningCard() => Container(
        decoration: BoxDecoration(
          color: AppColors.primaryContainer,
  ...
  Widget _buildEmptyUpcoming() => Container(
  ...
  Widget _buildUpcomingCard(Map<String, dynamic> assessment) {
    ...
    final subjectIcon = _subjectIcon(subject);

    return GestureDetector(
      onTap: () =>
          context.push('/student/assessments/${assessment['_id']}/start'),
      child: Container(
