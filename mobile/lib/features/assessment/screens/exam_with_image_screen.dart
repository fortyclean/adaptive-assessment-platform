...
/// Exam With Image Screen — Design _41
///
/// Variant of the exam screen that:
/// - Shows an image placeholder inside the question card
/// - Has Previous / Next navigation buttons in the footer
/// - Displays question number badge + progress bar
/// - Timer shown in header with error color when <= 60s
///
/// Requirements: 7.1–7.11
class ExamWithImageScreen extends ConsumerStatefulWidget {
  const ExamWithImageScreen({
  ...
  @override
  ConsumerState<ExamWithImageScreen> createState() =>
      _ExamWithImageScreenState();
}

class _ExamWithImageScreenState extends ConsumerState<ExamWithImageScreen>
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: _isTimerWarning
                    ...
                    : AppColors.errorContainer.withValues(alpha: 0.10),
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              // Custom radio indicator (RTL: left)
              if (isSelected)
                Container(
                  width: 24,
                  height: 24,
