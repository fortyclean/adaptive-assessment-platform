...
class _SchoolReportsScreenState extends ConsumerState<SchoolReportsScreen> {
  ...
  Widget _buildStrengthsWeaknessesRow() => Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Strengths card
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  const _SkillChip(
                      label: 'الرياضيات - الجبر', isStrength: true),
                  const SizedBox(height: 6),
                  const _SkillChip(label: 'العلوم - الأحياء', isStrength: true),
                  const SizedBox(height: 6),
                  const _SkillChip(
                      label: 'اللغة العربية - النحو', isStrength: true),
                  const SizedBox(height: 12),
                  Text(
