...
class _ClassroomListScreenState extends ConsumerState<ClassroomListScreen> {
  ...
  Widget _buildSearchAndAdd(BuildContext context) => Row(
        children: [
  ...
  Widget _buildPerformanceOverview() => Row(
        children: [
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                              content: Text('عرض جميع التنبيهات'),
                              behavior: SnackBarBehavior.floating),
                        );
                      },
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('جاري تحميل التقرير الكامل...'),
                            behavior: SnackBarBehavior.floating),
                      );
                    },
                    style: ElevatedButton.styleFrom(
